...
[bestacc,bestc,bestg] = SVMcgForClass(train_label, train_data_scale, -5, 15, -15, 3, 5, 2, 2);
model = svmtrain(train_label, train_data_scale, ['-c ', num2str(bestc), ' -g ', num2str(bestg)]);
[predict, accuracy] = svmpredict(test_label, test_data_scale, model);
